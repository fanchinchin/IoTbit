...
namespace ESP8266_IoT {
    ...
    export function postIFTTT(value1: string, value2: string, value3: string): void {
        ...
        //let sendST = "https://maker.ifttt.com/trigger/test/with/key/ccDYGg9H2KqdGwU4ly8fJ1?value1=" + value1 + "&value2=" + value2 + "&value3=" + value3
        let sendST = "https://maker.ifttt.com/trigger/test/with/key/ccDYGg9H2KqdGwU4ly8fJ1?value1=11&value2=22&value3=33"

        //let sendST = sendST1 + sendST2
        sendAT(sendST, 1000)
        basic.showString(sendST)
    ...
    */
    ...
    //% value.defl=value
    //成功
    export function IFTTTWebhook(ip: string, event_name: string, key: string, value1: number, value2: number, value3: number) {
